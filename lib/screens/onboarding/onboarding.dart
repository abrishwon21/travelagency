...
import 'pages/transport/index.dart';
import 'pages/onboarding_page.dart';
import 'pages/visit/index.dart';
  ...
  Widget _getPage() {
    switch (_currentPage) {
      ...
      case 2:
        return OnboardingPage(
          number: 2,
          lightCardChild: const TransportLightCardContent(),
          darkCardChild: const TransportDarkCardContent(),
          lightCardOffsetAnimation: _slideAnimationLightCard,
          darkCardOffsetAnimation: _slideAnimationDarkCard,
          textColumn: const TransportTextColumn(),
        );
      case 3:
        return OnboardingPage(
          number: 3,
          lightCardChild: const VisitLightCardContent(),
          darkCardChild: const VisitDarkCardContent(),
          lightCardOffsetAnimation: _slideAnimationLightCard,
          darkCardOffsetAnimation: _slideAnimationDarkCard,
          textColumn: const VisitTextColumn(),
        );
      default:
