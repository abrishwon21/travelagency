...
import 'package:travel_app/screens/auth_screens/widgets/Signup_form.dart';
...
class _LoginState extends State<SignUp> with SingleTickerProviderStateMixin {
            ...
            child: Padding(
              ...
              child: Column(
                children: <Widget>[
                  ...
                  const Spacer(),
                  SignUpForm(animation: _formElementAnimation),
                ],
              ),
            ),
          ),
